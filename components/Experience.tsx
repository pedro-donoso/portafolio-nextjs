 ...
 return (
  <section className="mt-5" id="experiencia">
   ...
   <ul className="list-disc list-inside ml-5 mb-5 text-justify">
    ...
    <li>
     Integración de soluciones de pago seguras utilizando <strong>Flow</strong>{" "}
     y <strong>Transbank</strong>, garantizando transacciones confiables.
    </li>
   </ul>
   ...
   <ul className="list-disc list-inside ml-5 mb-5 text-justify">
    ...
    <li>
     ...
     <strong>GitLab</strong> para garantizar la compatibilidad y el rendimiento
     óptimo.
    </li>
    <li>
